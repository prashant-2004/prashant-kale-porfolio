        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-center">
          <div className="lg:col-span-3 space-y-8">
            ...
            <div className="flex gap-4 animate-fade-in" style={{ animationDelay: '1s' }}>
              <a 
                ...
                className="w-10 h-10 rounded-full flex items-center justify-center bg-dark-lighter border border-purple/20 text-white hover:text-purple hover:border-purple transition-colors"
                aria-label="GitHub"
              >
                <Github size={20} />
              </a>
          ...
          <div className="lg:col-span-2 flex items-center justify-center lg:justify-end animate-fade-in" style={{ animationDelay: '1.2s' }}>
            <div className="w-64 h-64 sm:w-80 sm:h-80 relative">
              {/* Circle image frame with gradient border */}
